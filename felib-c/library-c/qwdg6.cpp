/* qwdg6.f -- translated by f2c (version of 28 August 1991  0:07:02).
...
/* Subroutine */ int qwdg6_(wght, iwght, abss, iabss, jabss, nqp, itest)
doublereal *wght;
integer *iwght;
doublereal *abss;
 ...
 */
/* PURPOSE */
/*      QWDG6 returns weights and abscissae for a 6-point quadrature */
...
/* L1000: */
    ...
    abss[abss_dim1 * 6 + 1] = -.5;
    abss[abss_dim1 * 6 + 2] = sqrt(3.) / 2.;
