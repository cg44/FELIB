/* chofwd.f -- translated by f2c (version of 28 August 1991  0:07:02).
...
/* Subroutine */ int chofwd_(a, ia, ja, r, ir, n, hband, itest)
doublereal *a;
integer *ia, *ja;
doublereal *r;
integer *ir, *n, *hband, *itest;
{
    ...
    static char srname[6+1] = "CHOFWD";

    /* System generated locals */
    integer a_dim1, a_offset, i__1, i__2;

    /* Local variables */
    static integer i, j, k, w;
    static doublereal x;
    static integer ij;
 ...
 */
/* PURPOSE */
/*      CHOFWD performs forward substitution on a matrix reduced by */
/*      CHORDN */
...
/* ARGUMENTS out */
/*      R       on exit, contains the reduced vector of rhs's */
