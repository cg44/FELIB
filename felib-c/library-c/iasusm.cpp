/* iasusm.f -- translated by f2c (version of 28 August 1991  0:07:02).
...
/* Subroutine */ int iasusm_(sysk, isysk, jsysk, elk, ielk, jelk, steer, 
 ...
 */
/* PURPOSE */
/*      IASUSM for complex unsymmetric system matrix, assembles */
/*      contribution from real element matrix into */
/*      the imaginary part of a complex system matrix */
...
/*     Range checking on STEERI and STEERJ */
			...
			*itest = errmes_(&jtest, &ierror, srname, 6L);
		    ...
		    sysk[(steeri + offset * sysk_dim2 << 1) + 2] += elk[i + j 
			    * elk_dim1];
		}
/* L1000: */
	    }
