C***********************************************************************
      SUBROUTINE CSYBAK(KB, IKB, JKB, LOADS, ILOADS, N, HBAND,
     *     ITEST)
C-----------------------------------------------------------------------
C PURPOSE
C      PERFORMS BACKWARD SUBSTITUTION ON A COMPLEX MATRIX PROCESSED BY
C      CSYRDN AND CSYFWD
C
C HISTORY
C
...
C              BANDWIDTH HBAND, REDUCED BY CSYRDN OR CSYSOL
