...
C
      ...
      WRITE (NOUT,FMT=9960) TOTNOD,DIMEN
      DO 1000 I = 1,TOTNOD
          READ (NIN,FMT=9980) NODNUM, (COORD(NODNUM,J),J=1,DIMEN)
          WRITE (NOUT,FMT=9950) NODNUM, (COORD(NODNUM,J),J=1,DIMEN)
 1000 CONTINUE
C
...
C
      ...
      WRITE (NOUT,FMT=9960) ELTYP,TOTELS,NODEL
      DO 1010 I = 1,TOTELS
          READ (NIN,FMT=9990) ELNUM, (ELTOP(ELNUM,J+2),J=1,NODEL)
          WRITE (NOUT,FMT=9960) ELNUM, (ELTOP(ELNUM,J+2),J=1,NODEL)
          ELTOP(ELNUM,1) = ELTYP
          ELTOP(ELNUM,2) = NODEL
 1010 CONTINUE
C
...
C
      ...
      WRITE (NOUT,FMT=9960) DOFNOD
      READ (NIN,FMT=9990) TOTBND
      WRITE (NOUT,FMT=9960) TOTBND
      DO 1020 I = 1,TOTBND
          READ (NIN,FMT=9990) BTYPE,NUMNOD,NODSID,
     *      (BDCND(I,J+3),J=1,NUMNOD)
          WRITE (NOUT,FMT=9960) BTYPE,NUMNOD,NODSID,
     *      (BDCND(I,J+3),J=1,NUMNOD)
          BDCND(I,1) = BTYPE
          BDCND(I,2) = NUMNOD
          BDCND(I,3) = NODSID
