...
C
      ...
      WRITE (NOUT,FMT=9940) NSTEPS,DTIM,THETA
      READ (NIN,FMT=9970) ALPHA,BETA
      WRITE (NOUT,FMT=9910) ALPHA,BETA
C
...
C
      READ (NIN,FMT=9970) AMP,OMEGA,PHASE
      WRITE (NOUT,FMT=9910) AMP,OMEGA,PHASE
      READ (NIN,FMT=9990) NUMLOD
      WRITE (NOUT,FMT=9950) NUMLOD
      TOTLOD = 0
      DO 1040 I = 1,NUMLOD
          READ (NIN,FMT=9990) NODNUM, (NWORK(J),J=1,DOFNOD)
          WRITE (NOUT,FMT=9950) NODNUM, (NWORK(J),J=1,DOFNOD)
          DO 1030 J = 1,DOFNOD
...
C
      READ (NIN,FMT=9990) OUTNOD,FREDOM
      WRITE (NOUT,FMT=9950) OUTNOD,FREDOM
C
C
...
C     each TIME step
C
      WRITE (NOUT,FMT=9890) OUTNOD,FREDOM
 ...
 1130     CONTINUE
          ...
          WRITE (NOUT,FMT=9860) TIME,A1(FREDOM),DA1(FREDOM),D2A1(FREDOM)
 1140 CONTINUE
C
C     End of Program
C
