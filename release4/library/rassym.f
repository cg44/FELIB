...
C-----------------------------------------------------------------------
C PURPOSE
C      RASSYM adds the contribution from an element matrix into real 
C      part of a complex SYSK
C
C HISTORY
C
...
C      ERRMES
C
C     SUBROUTINE RASSYM(SYSK,ISYSK,JSYSK,ELK,IELK,JELK,STEER,ISTEER,
C    *                  HBAND,DOFEL,ITEST)
C***********************************************************************
C
