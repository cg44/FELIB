C***********************************************************************
C     $Id: seg3p4.f,v 1.2 2009/02/27 11:44:50 cg44 Exp $
C
...
C
C     Finite Library Program: Seg3p4 - Two Dimensional Free Surface                                   Solution
C
C***********************************************************************
C
...
C
      WRITE (NOUT,9880)
      READ (NIN,9990) NUMFRE
      WRITE (NOUT,9940) NUMFRE
C
      READ (NIN,9990) (FRENOD(I),I=1,NUMFRE)
      WRITE (NOUT,9940) (FRENOD(I),I=1,NUMFRE)
      DO 1030 I = 1,NUMFRE
          NODE = FRENOD(I)
...
C
      WRITE (NOUT,9870)
      READ (NIN,9990) NUMSEP
      WRITE (NOUT,9940) NUMSEP
C
      READ (NIN,9990) (SEPNOD(I),I=1,NUMSEP)
      WRITE (NOUT,9940) (SEPNOD(I),I=1,NUMSEP)
C
...
C
      READ (NIN,9960) MAXIT,CFACTR
      WRITE (NOUT,9860) MAXIT,CFACTR
C
...
C
      WRITE (NOUT,9810)
      DO 1170 I = 1,TOTNOD
          WRITE (NOUT,9930) I, (COORD(I,J),J=1,DIMEN)
 1170 CONTINUE
C
C     Program end
C
