C***********************************************************************
C     $Id: seg4p1.f,v 1.2 2009/02/27 11:44:50 cg44 Exp $
C
...
C
      WRITE (NOUT,9910)
      READ (NIN,9970) (PERM(I),I=1,DIMEN)
      WRITE (NOUT,9900) (PERM(I),I=1,DIMEN)
...
C
      ...
      WRITE (NOUT,9870) INTNOD
      DO 1060 I = 1,INTNOD
          READ (NIN,9960) NODNUM,WORK1(1)
          WRITE (NOUT,9930) NODNUM,WORK1(1)
          J = NF(NODNUM,1)
          RHS(J) = WORK1(1)
 1060 CONTINUE
C
...
C
      ...
      WRITE (NOUT,9850) NSTEPS,DTIM,THETA
C
