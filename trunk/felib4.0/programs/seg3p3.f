C***********************************************************************
C     $Id: seg3p3.f,v 1.2 2009/02/27 11:44:50 cg44 Exp $
C
...
C
      WRITE (NOUT,9910)
      READ (NIN,9970) FREQ,COND,PERM
      WRITE (NOUT,9900) FREQ,COND,PERM
      OMEGA = 2.0D0*PI*FREQ
C
...
C
      DO 1020 I = 1,BNDNOD
          READ (NIN,9980) BNODE(I),BVAL(1,I),BVAL(2,I)
          WRITE (NOUT,9940) BNODE(I),BVAL(1,I),BVAL(2,I)
 1020 CONTINUE
C
...
C
          DO 1030 I = 1,NJV
              READ (NIN,9980) ELNUM,JVAL(ELNUM)
              WRITE (NOUT,9930) ELNUM,JVAL(ELNUM)
 1030     CONTINUE
      END IF
C
...
C
     ...
     *                    FIELD,IFIELD,ITEST)
              ...
              WRITE (NOUT,9850) IQUAD
              WRITE (NOUT,9840) (FIELD(I),I=1,2),BMOD
 1130     CONTINUE
 1140 CONTINUE
C
C     End of program
