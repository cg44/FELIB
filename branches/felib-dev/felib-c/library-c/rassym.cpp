/* rassym.f -- translated by f2c (version of 28 August 1991  0:07:02).
...
/* Subroutine */ int rassym_(sysk, isysk, jsysk, elk, ielk, jelk, steer, 
 ...
 */
/* PURPOSE */
/*      RASSYM adds the contribution from an element matrix into real */
/*      part of a complex SYSK */
...
/*     Main loops */
	...
	if (steer[i] != 0) {
		...
		if (steer[j] != 0) {
			...
			sysk[(steeri + cd * sysk_dim2 << 1) + 1] += elk[i + j 
				* elk_dim1];
		    }
		}
/* L1000: */
