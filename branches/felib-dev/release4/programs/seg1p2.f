...
C
      DO 1010 I = 1,TOTELS
          READ (NIN,FMT=9990) ELNUM,MATTYP,NODEL,
     *      (ELTOP(ELNUM,J+2),J=1,NODEL)
          WRITE (NOUT,FMT=9950) ELNUM,MATTYP,NODEL,
     *      (ELTOP(ELNUM,J+2),J=1,NODEL)
...
C
      WRITE (NOUT,FMT=9920)
      READ (NIN,FMT=9990) NUMMAT
      WRITE (NOUT,FMT=9910) NUMMAT
C
      READ (NIN,FMT=9970) (PROP(I,1),I=1,NUMMAT)
      READ (NIN,FMT=9970) (PROP(I,2),I=1,NUMMAT)
      WRITE (NOUT,FMT=9900) ((PROP(I,J),I=1,NUMMAT),J=1,2)
C
...
C
      DO 1030 ITYPE = 1,LODNOD
          READ (NIN,FMT=9990) BTYPE,NODSID,NUMNOD,
     *      (BDCND(ITYPE,J+3),J=1,NUMNOD)
          READ (NIN,FMT=9970) (PRSSR(ITYPE,I),I=1,DOFNOD)
          WRITE (NOUT,FMT=9950) BTYPE,NODSID,NUMNOD,
     *      (BDCND(ITYPE,J+3),J=1,NUMNOD)
          WRITE (NOUT,FMT=9900) (PRSSR(ITYPE,I),I=1,DOFNOD)
          BDCND(ITYPE,1) = BTYPE
