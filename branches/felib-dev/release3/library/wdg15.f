...
C
     ...
     *     DNCL, DNCZ, DNMQL, DNMQZ, DNMTL, DNMTZ, DUMMY, ETA,
     *     FUN, L1, L2, L3, LA, LB, NC, NMQ, NMT, SRNAME, VEPS,
     *     XI, XMAX, XMIN, YMAX, YMIN, Z, ZETA, ZM, ZP, ZVAL
...
C
     ...
     *     ETA.GT.YMAX) .OR. DABS(ZETA).GT.ZVAL) IERROR = 3
