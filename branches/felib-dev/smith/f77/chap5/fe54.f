      PROGRAM P54                                                               
C                                                                               
C      PROGRAM 5.4 PLANE STRAIN OF AN ELASTIC                                   
C      SOLID USING 8-NODE QUADRILATERAL ELEMENTS                                
C                                                                               
C                                                                               
...
C                                                                               
     ...
     +DER(2,8),DERIV(2,8),BEE(3,16),DBEE(3,16),                                 
     +BTDB(16,16),KM(16,16),ELD(16),EPS(3),SIGMA(3),                            
     +BT(16,3),FUN(8),KB(IKB1,IKB2),LOADS(ILOADS)                               
